...
# 检查命令行参数
if len(sys.argv) < 2:
    print("用法: python analyze_campaign.py <数据文件路径>")
    print("示例: python analyze_campaign.py examples/analyzing-marketing-campaign/material/campaign_data_week1_china.csv")
    sys.exit(1)
